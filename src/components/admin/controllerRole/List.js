...
const defaultState = {
    type: { name: 'Loại' },
    name: { name: 'Tên chức năng', sort: NONE },
    list_controller: { name: 'Danh sách controller', sort: NONE },
    order_by: { name: 'Thứ tự', sort: NONE },
    tool: { name: 'Công cụ' }
}
export default class List extends Component {
    ...
    getAll = (models) => {
        const { is_loading, onDelete, onGetEdit, listChecked, onChecked, actChangeOrderRequest } = this.props;
        var results = null;
