...
const defaultState = {
    bank_take: { name: 'Ví nhận', sort: NONE },
    bank_move: { name: 'Ví chuyển', sort: NONE },
    price: { name: 'Số tiền', sort: NONE },
    fee: { name: 'Phí', sort: NONE },
    reason: { name: 'Lý do' },
    custome_date: { name: 'Thời gian' },
    tool: { name: 'Công cụ' }
}
export default class List extends Component {
    ...
    getAll = (models) => {
        const { is_loading, onDelete, onGetEdit, listChecked, onChecked, onChangeField, auth } = this.props;
        var results = null;
