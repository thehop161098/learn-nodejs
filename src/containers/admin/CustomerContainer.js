...
import * as actCustomer from '../../actions/admin/actCustomer';
import {
    openForm, closeForm,
...
class CustomerContainer extends Component {
    ...
    componentDidMount() {
        ...
        let roles_access = this.props.roles['GameTransactionBuyContainer'] ? this.props.roles['GameTransactionBuyContainer'] : [];
    ...
    onGetAll = (search) => {
        ...
        this.props.actGetAllRequest(search).then(() => {
...
const mapProps = merge(actCustomer, actIndex);
export default connect(mapState, mapProps)(CustomerContainer);