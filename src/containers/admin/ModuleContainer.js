...
import * as actModule from '../../actions/admin/actModule';
import {
    openForm, closeForm,
...
class ModuleContainer extends Component {
    ...
    componentDidMount() {
        ...
        let roles_access = this.props.roles['ModuleContainer'] ? this.props.roles['ModuleContainer'] : [];
    ...
    render() {
        return (
            <ModulePage
                {...this.state}
                {...this.props}
                onGetModuleParent={this.props.actGetModuleParent}
...
const mapProps = merge(actModule, actIndex);
export default connect(mapState, mapProps)(ModuleContainer);