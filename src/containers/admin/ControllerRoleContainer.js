...
import * as actControllerRole from '../../actions/admin/actControllerRole';
import ControllerRolePage from '../../pages/admin/ControllerRolePage';
import {
    openForm, closeForm,
...
class ControllerRoleContainer extends Component {
    ...
    render() {
        return (
            ...
            // onGetControllers={actGetControllers}
            // onChangeOrder={actChangeOrderRequest}
            />
        );
    }
}
...
const mapProps = merge(actControllerRole, actIndex);
export default connect(mapState, mapProps)(ControllerRoleContainer);