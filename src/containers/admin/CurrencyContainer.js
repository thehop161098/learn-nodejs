...
import * as actCurrency from '../../actions/admin/actCurrency';
import {
    openForm, closeForm,
...
class CurrencyContainer extends Component {
    ...
    componentDidMount() {
        ...
        let roles_access = this.props.roles['CurrencyContainer'] ? this.props.roles['CurrencyContainer'] : [];
...
const mapProps = merge(actCurrency, actIndex);
export default connect(mapState, mapProps)(CurrencyContainer);