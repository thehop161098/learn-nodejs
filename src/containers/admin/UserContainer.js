...
class UserContainer extends Component {
    ...
    componentDidMount() {
        ...
        let roles_access = this.props.roles['UserContainer'] ? this.props.roles['UserContainer'] : [];
...
const mapProps = merge(actUser, actIndex);
export default connect(mapState, mapProps)(UserContainer);